...
PROC IML;
   ...
   MEDIA=REPEAT(0,1,M);
   sigma2=0.6;
   R=sigma2*{1 0.0622 0.00001 0, 0.0622 1 0.0622 0.00001, 0.00001 0.0622 1 0.0622, 0 0.00001 0.0622 1};
...
outfile="F:\Tesis\SAS\Programas (27-07)\gau.cvs"
dbms=csv replace;
run;
...
plot vario*distance=1 p_vario*distance=2
	/ overlay haxis=axis1 vaxis=axis2 vref=0.5934; 
...
axis2  label=(h=2 A=90 "Variograma") value=(h=1.5) 
	order=(0 to 7 by 0.5) minor=none; 
